...
type NotificationServiceClient interface {
	Send(ctx context.Context, in *TaskEvent, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *notificationServiceClient) Send(ctx context.Context, in *TaskEvent, opts ...grpc.CallOption) (*Empty, error) {
...
type NotificationServiceServer interface {
	Send(context.Context, *TaskEvent) (*Empty, error)
...
func (UnimplementedNotificationServiceServer) Send(context.Context, *TaskEvent) (*Empty, error) {
...
func _NotificationService_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotificationServiceServer).Send(ctx, req.(*TaskEvent))
	}
...
var NotificationService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/proto/notification/v1/notification.proto",
}
